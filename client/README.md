...
金币、宝石及个人页资产卡均原地打开余额与最近变动浮窗，关闭不改变页面或滚动位置，不附加“+”按钮；浮窗提供“获得”（活动页 full）与“充值”（商城 full）。half 货币栏从千位起使用 K/M 缩写，full 的当前 52,860 保留完整；更大的数值仍使用短格式，浮窗显示完整值并覆盖 9 位数。主导航和明确的内容入口才进行页面跳转；详情、规则、表单和游戏操作不转回首页。
